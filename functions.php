...
class Functions
{
    ...
    public function setFragmentSize(int $fragment_size)
    {
     ...
     */
    public function text(string $payload)
    {
        $this->send($payload);
    }
     ...
     */
    public function binary(string $payload)
    {
     ...
     */
    public function ping(string $payload = '')
    {
     ...
     * @param string $payload Optional text as string
     */
    public function pong(string $payload = '')
    {
     ...
     */
    protected function sendFragment(bool $final, string $payload, string $opcode, bool $masked)
    {
        $data = '';
    ...
    public function receive()
    {
        ...
        //$factory = new Factory();
		print_r($this->options['return_obj']);
    ...
    protected function read(string $length)
    {
        $data = '';
